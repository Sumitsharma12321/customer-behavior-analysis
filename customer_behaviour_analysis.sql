...
-- Q1. What is the total revenue generated by Men vs Female customer?
select gender , sum(purchase_amount) as total_revenue 
from customer
group by gender;

-- Q2. Which customer use a discount but stil spent more than the average purchase amount?
...
-- between Subscriber and not subscriber.
...
select subscription_status , 
count(customer_id) as repeated_buyer
from customer
